...
import SimpleListGenerator from "./GeneratorForSimpleList";
...
export const payloadGenerateForSimpleList = (value: string) => {
  return new SimpleListGenerator(value);
};
...
export const payloadGenerateForCharacter = (
  options: BruteForcerGenerateOption
) => {
  return new BruteForcerGenerator(options);
};

export const payloadGenerateForDirectoryTraversal = (
  options: DirectoryTraversalGenerateOption
) => {
