...
const DateGenerate: React.FC<Props> = ({ onApply }: Props) => {
  ...
  return (
    <div className={styles.payloadContent}>
      <div className={styles.generateDateOptionContainer}>
        <div className={styles.generateDateParamGroup}>
        ...
        <div className={styles.generateDateNotices}>
