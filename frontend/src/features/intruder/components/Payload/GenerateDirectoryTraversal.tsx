...
const DirectoryTraversal: React.FC<Props> = ({ onApply }: Props) => {
  ...
  return (
    <div className={styles.payloadContent}>
      <div
        className={styles.generateDirectoryTraversalOptionContainer}
        ref={optionsRef}
      >
        <div className={styles.generateDirectoryTraversalParamGroup}>
