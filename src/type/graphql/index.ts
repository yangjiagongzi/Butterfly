...
export type AppMutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['AppMutation'] = ResolversParentTypes['AppMutation']> = {
  clipboardWriteText?: Resolver<Maybe<ResolversTypes['MutationResult']>, ParentType, ContextType, Partial<AppMutationClipboardWriteTextArgs>>;
  showMessageBox?: Resolver<Maybe<ResolversTypes['MutationResult']>, ParentType, ContextType, Partial<AppMutationShowMessageBoxArgs>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type AppQueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['AppQuery'] = ResolversParentTypes['AppQuery']> = {
...
export type ConfigMutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConfigMutation'] = ResolversParentTypes['ConfigMutation']> = {
  updateConfig?: Resolver<Maybe<ResolversTypes['MutationResult']>, ParentType, ContextType, Partial<ConfigMutationUpdateConfigArgs>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ConfigQueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['ConfigQuery'] = ResolversParentTypes['ConfigQuery']> = {
...
export interface ConfigValueScalarConfig extends GraphQLScalarTypeConfig<ResolversTypes['ConfigValue'], any> {
  name: 'ConfigValue';
}
...
export type DictFileQueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['DictFileQuery'] = ResolversParentTypes['DictFileQuery']> = {
...
export type DictTypeQueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['DictTypeQuery'] = ResolversParentTypes['DictTypeQuery']> = {
